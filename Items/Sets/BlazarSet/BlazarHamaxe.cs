...
{
    public class BlazarHamaxe : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Blazar Hamaxe");
        ...
        {
            Texture2D Texture = ModContent.Request<Texture2D>("earthmod/Items/Sets/BlazarSet/BlazarHamaxe_Glowmask").Value;
            spriteBatch.Draw
            (
                Texture,
                new Vector2
